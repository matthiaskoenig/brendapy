...
OrderedDict([('protein_id', 8),
             ...
             ('RT', {'redox reaction', 'oxidation', 'reduction'}),
             ('SA',
              [{'data': '3.3', 'refs': [12], 'units': 'µmol/min/mg'},
               {'data': '0.6', 'refs': [16], 'units': 'µmol/min/mg'},
               {'data': '0.65', 'refs': [21], 'units': 'µmol/min/mg'},
               {'data': '1.47', 'refs': [14], 'units': 'µmol/min/mg'},
               {'comment': '#9# ADH-3 <49>',
                'data': '1.3',
                'refs': [18, 49],
                'units': 'µmol/min/mg'}]),
             ...
             ('ST',
              [{'comment': '#5# isoenzyme A2 and B2 <48>; #36# isoenzyme '
               ...
               {'data': 'skin', 'refs': [194]},
               {'data': 'hepatoma cell', 'refs': [180]},
               {'data': 'serum', 'refs': [194]},
               {'data': 'adenocarcinoma cell', 'refs': [229]},
